...
select case when exists(select 1 from warehouse_v7.carpet_roll where tenant_id=:'tenant' and id=:'roll' and roll_number='RC2355' and manufacturer_roll='1000185284' and remaining_sixteenths=31496 and measure_status='FULL') then 1 else 1/0 end as carpet_row_ok;
