...
select case when (select count(*) from warehouse_v7.inventory_movement where tenant_id=:'tenant' and command_id=:'rcmd' and carpet_roll_id=:'roll' and movement_type='RECEIVE_CARPET')=1 then 1 else 1/0 end as movement_ok;
