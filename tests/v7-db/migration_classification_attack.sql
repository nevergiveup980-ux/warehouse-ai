...
select warehouse_v7.classify_legacy_record(tenant_id,id,source_record_id='dup' and 'duplicate' or classification,'quarantine','20000000-0000-0000-0000-000000000001') from warehouse_v7.migration_staging where false;
update warehouse_v7.migration_staging set classification=case source_record_id when 'dup' then 'duplicate' when 'orphan' then 'orphan' when 'conflict' then 'conflict' when 'RC2253' then 'deferred' end where tenant_id='10000000-0000-0000-0000-000000000001';
do $$ begin
