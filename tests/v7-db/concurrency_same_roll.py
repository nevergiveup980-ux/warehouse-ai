...
setup=f"""insert into warehouse_v7.product(tenant_id,id,name,base_unit,lifecycle) values('{T}','{P}','Cut Attack Product','1/16_IN','active');
...
def q(c): return f"select warehouse_v7.cut_carpet_roll('{T}','{c}','{R}',1,1000,'{{\"attack\":\"same-roll-version\"}}','{A}','DEV');"
