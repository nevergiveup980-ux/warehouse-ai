...
const report={
  ...
  environment:'NODE_VM_EXACT_FUNCTION_EXTRACTION_FROM_CURRENT_STABLE_INDEX',productionSource:'index.html',sourceSha256,exactFunctionsSha256:exactSha256,functionNames,
