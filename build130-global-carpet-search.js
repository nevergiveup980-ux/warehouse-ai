// RUNLU Warehouse OS V6.12.35 Build130 · Global Carpet Search
...
(() => {
  'use strict';
  if(window.__RUNLU_BUILD130_GLOBAL_CARPET_SEARCH__)return;
  window.__RUNLU_BUILD130_GLOBAL_CARPET_SEARCH__=true;
  ...
  function install(){
    ...
    if(prior.__build130GlobalCarpetSearch){installed=true;return true}
    const wrapped=function(){return renderWithGlobalSearch(prior,this,arguments)};
    wrapped.__build130GlobalCarpetSearch=true;wrapped.__original=prior;
    window.renderCarpetInventory=wrapped;installed=true;
    document.documentElement.setAttribute('data-runlu-build130-global-search','ready');
    return true;
  }
  ...
  window.RUNLUGlobalCarpetSearchBuild130={version:BUILD,appVersion:VERSION,searchText,readFilterState,writeFilterState,renderWithGlobalSearch,get installed(){return installed}};
})();
