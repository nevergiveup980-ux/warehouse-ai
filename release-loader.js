...
(() => {
  ...
  const files=[
    ...
    'build111-sales-followup-workflow.js',
    'build112-product-link-recovery.js',
    'build113-general-sample-checkout.js',
    'build114-transfer-edit-routing.js',
    ...
    'build121-quiet-product-recovery-notice.js',
    'build122-cloud-delete-safety.js',
    'build123-cloud-status-ux.js',
    'build124-shared-carpet-physical-identity.js',
    ...
    'build128-carpet-cut-transaction-guard.js',
    'build129-carpet-cut-cloud-atomic-r1.js',
